...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double hourseDegree =
        (hour < 12) ? 360 / 12 * hour : 360 / 12 * (hour - 12);
    ...
    for (int i = 0; i < 60; i++) {
      ...
      double x1 = (size.width / 2) +
          (size.width / 4 + distance) * cos(vector.radians(degree));
      double y1 = (size.height / 2) +
          (size.width / 4 + distance) * sin(vector.radians(degree));
      final p1 = Offset(x1, y1);

      double x2 = (size.width / 2) +
          (size.width / 4 + 30) * cos(vector.radians(degree));
      double y2 = (size.height / 2) +
          (size.width / 4 + 30) * sin(vector.radians(degree));
    ...
    for (int i = 0; i < 60; i++) {
      ...
      paint.color =
          (i * 6 == minuteDegree) ? Color(0xffffdd00) : Colors.transparent;
    ...
    for (int i = 0; i < 12; i++) {
      ...
      paint.color =
          (i * 30 == hourseDegree) ? Color(0xFF0031EC) : Colors.transparent;
      paint.strokeWidth = 7;
    ...
    for (int i = 0; i < 60; i++) {
      ...
      paint.color =
          (i * 6 <= secondDegree) ? Color(0xFFE21B1B) : Colors.transparent;
      paint.strokeWidth = (i % 5 == 0) ? 7 : 5;
      ...
      double x1 = (size.width / 2) +
          (size.width / 5 + distance) * cos(vector.radians(degree));
      double y1 = (size.height / 2) +
          (size.width / 5 + distance) * sin(vector.radians(degree));
      final p1 = Offset(x1, y1);
    ...
    for (int i = 0; i < 12; i++) {
      double degree = 360 / 12 * i;
      paint.color = (i * 30 == hourseDegree && hourseDegree == minuteDegree)
          ? Color(0xFF32BB00)
          : Colors.transparent;
